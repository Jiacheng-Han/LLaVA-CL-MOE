...
# --- 测试1-IL-EV17 ---
echo "--- 测试1-IL-EV17 ---"
output="/media/AI4MED1/hanjiacheng/LLaVA-CL-MOE/output/2-IS-EV17/3.11/IL-EV17.jsonl"
...
# --- 测试2-IS-EV17 ---
echo " --- 测试2-IS-EV17 ---"
output="/media/AI4MED1/hanjiacheng/LLaVA-CL-MOE/output/2-IS-EV17/3.11/IS-EV17.jsonl"
