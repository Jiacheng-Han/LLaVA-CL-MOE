...
# 指向刚训练好的路径
MODEL_PATH="/media/AI4MED1/hanjiacheng/LLaVA-CL-MOE/checkpoints/2-IS-EV17/llava-med-v1.5-moe-lora-3.11"
...
ANSWERS_FILE="/media/AI4MED1/hanjiacheng/LLaVA-CL-MOE/output/2-IS-EV17/3.11/IL-EV17.jsonl"
