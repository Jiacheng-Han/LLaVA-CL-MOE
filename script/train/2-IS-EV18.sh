...
DATA_PATH="/media/AI4MED1/hanjiacheng/Surgical-VQACL-Data/IS-EV18/instrument_state_ev18_train.json"
...
OUTPUT_DIR="/media/AI4MED1/hanjiacheng/LLaVA-CL-MOE/checkpoints/2-IS-EV18/llava-med-v1.5-moe-lora-3.1"
